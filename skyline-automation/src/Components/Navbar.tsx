          ...
          <div className="navbar__container">
            ...
            <div className="navbar__contact-group">
              ...
              <div className="navbar__contact-links">
                <a href="mailto:skyline@example.com" className="navbar__contact-link">
                  skyline@example.com
                </a>
                <a href="mailto:info@skyline.com" className="navbar__contact-link">
                  info@skyline.com
                </a>
              </div>
            </div>
              ...
              <li key={link.href} className="navbar__mobile-nav-item">
                <Link
                  ...
                  className={`navbar__mobile-nav-link ${
                    isActiveLink(link.href) ? "navbar__mobile-nav-link--active" : ""
                  }`}
                >
                  {link.label}
                </Link>
