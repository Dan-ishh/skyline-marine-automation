...
export const products: Product[] = [
  ...
  // Dummy products for testing - One per brand
  {
    id: "prod-dummy-001",
    name: "Caterpillar Marine Engine Test Product",
    slug: "cat-marine-engine-test",
    brandId: "caterpillar-8",
    categoryId: "caterpillar-3516",
    category: "Main Engines",
    description: "Test product for Caterpillar Marine category page.",
    price: 0,
    images: ["/Assets/images/Products/Diesel-engine-And-Generators-v1.jpg"],
    specifications: { "Test Product": "Yes" },
    inStock: true,
    featured: false,
    enquiryCount: 5,
  ...
  {
    id: "prod-dummy-002",
    name: "Cummins Marine Engine Test Product",
    slug: "cummins-marine-engine-test",
    brandId: "cummins-18",
    categoryId: "cummins-kt50",
    category: "Main Engines",
    description: "Test product for Cummins Marine category page.",
    price: 0,
    images: ["/Assets/images/Products/Diesel-engine-And-Generators-v1.jpg"],
    specifications: { "Test Product": "Yes" },
    inStock: true,
  ...
  {
    id: "prod-dummy-003",
    name: "Deutz Marine Engine Test Product",
    slug: "deutz-marine-engine-test",
    brandId: "deutz-3",
    categoryId: "deutz-parts",
    category: "Engine Parts",
    description: "Test product for Deutz category page.",
    price: 0,
    images: ["/Assets/images/Products/Diesel-engine-And-Generators-v1.jpg"],
    specifications: { "Test Product": "Yes" },
    inStock: true,
  ...
  {
    id: "prod-dummy-004",
    name: "Hanshin Marine Engine Test Product",
    slug: "hanshin-marine-engine-test",
    brandId: "hanshin-4",
    categoryId: "hanshin-parts",
    category: "Engine Parts",
    description: "Test product for Hanshin category page.",
    price: 0,
    images: ["/Assets/images/Products/Diesel-engine-And-Generators-v1.jpg"],
    specifications: { "Test Product": "Yes" },
    inStock: true,
  ...
  {
    id: "prod-dummy-005",
    name: "MaK Marine Engine Test Product",
    slug: "mak-marine-engine-test",
    brandId: "mak-5",
    categoryId: "mak-parts",
    category: "Engine Parts",
    description: "Test product for MaK category page.",
    price: 0,
    images: ["/Assets/images/Products/Diesel-engine-And-Generators-v1.jpg"],
    specifications: { "Test Product": "Yes" },
    inStock: true,
  ...
  {
    id: "prod-dummy-006",
    name: "MAN Diesel Engine Test Product",
    slug: "man-diesel-engine-test",
    brandId: "man-7",
    categoryId: "man-l32-40",
    category: "Main Engines",
    description: "Test product for MAN Diesel category page.",
    price: 0,
    images: ["/Assets/images/Products/Diesel-engine-And-Generators-v1.jpg"],
    specifications: { "Test Product": "Yes" },
    inStock: true,
  ...
  {
    id: "prod-dummy-007",
    name: "Mitsubishi Marine Engine Test Product",
    slug: "mitsubishi-marine-engine-test",
    brandId: "mitsubishi-8",
    categoryId: "mitsubishi-parts",
    category: "Engine Parts",
    description: "Test product for Mitsubishi category page.",
    price: 0,
    images: ["/Assets/images/Products/Diesel-engine-And-Generators-v1.jpg"],
    specifications: { "Test Product": "Yes" },
    inStock: true,
  ...
  {
    id: "prod-dummy-008",
    name: "Niigata Power Systems Test Product",
    slug: "niigata-power-systems-test",
    brandId: "niigata-9",
    categoryId: "niigata-parts",
    category: "Engine Parts",
    description: "Test product for Niigata Power Systems category page.",
    price: 0,
    images: ["/Assets/images/Products/Diesel-engine-And-Generators-v1.jpg"],
    specifications: { "Test Product": "Yes" },
    inStock: true,
  ...
  {
    id: "prod-dummy-009",
    name: "Pielstick Marine Engine Test Product",
    slug: "pielstick-marine-engine-test",
    brandId: "pielstick-10",
    categoryId: "pielstick-parts",
    category: "Engine Parts",
    description: "Test product for S.E.M.T. Pielstick category page.",
    price: 0,
    images: ["/Assets/images/Products/Diesel-engine-And-Generators-v1.jpg"],
    specifications: { "Test Product": "Yes" },
    inStock: true,
  ...
  {
    id: "prod-dummy-010",
    name: "SKL Marine Engine Test Product",
    slug: "skl-marine-engine-test",
    brandId: "skl-12",
    categoryId: "skl-parts",
    category: "Engine Parts",
    description: "Test product for SKL category page.",
    price: 0,
    images: ["/Assets/images/Products/Diesel-engine-And-Generators-v1.jpg"],
    specifications: { "Test Product": "Yes" },
    inStock: true,
  ...
  {
    id: "prod-dummy-011",
    name: "Sulzer Marine Engine Test Product",
    slug: "sulzer-marine-engine-test",
    brandId: "sulzer-13",
    categoryId: "sulzer-parts",
    category: "Engine Parts",
    description: "Test product for Sulzer category page.",
    price: 0,
    images: ["/Assets/images/Products/Diesel-engine-And-Generators-v1.jpg"],
    specifications: { "Test Product": "Yes" },
    inStock: true,
  ...
  {
    id: "prod-dummy-012",
    name: "Daihatsu Diesel Test Product",
    slug: "daihatsu-diesel-test",
    brandId: "daihatsu-14",
    categoryId: "daihatsu-parts",
    category: "Engine Parts",
    description: "Test product for Daihatsu Diesel category page.",
    price: 0,
    images: ["/Assets/images/Products/Diesel-engine-And-Generators-v1.jpg"],
    specifications: { "Test Product": "Yes" },
    inStock: true,
  ...
  {
    id: "prod-dummy-013",
    name: "Volvo Penta Marine Engine Test Product",
    slug: "volvo-penta-marine-engine-test",
    brandId: "volvo-15",
    categoryId: "volvo-penta-parts",
    category: "Engine Parts",
    description: "Test product for Volvo Penta category page.",
    price: 0,
    images: ["/Assets/images/Products/Diesel-engine-And-Generators-v1.jpg"],
    specifications: { "Test Product": "Yes" },
    inStock: true,
  ...
  {
    id: "prod-dummy-014",
    name: "Zexel Marine Engine Test Product",
    slug: "zexel-marine-engine-test",
    brandId: "zexel-18",
    categoryId: "zexel-parts",
    category: "Engine Parts",
    description: "Test product for Zexel category page.",
    price: 0,
    images: ["/Assets/images/Products/Diesel-engine-And-Generators-v1.jpg"],
    specifications: { "Test Product": "Yes" },
    inStock: true,
