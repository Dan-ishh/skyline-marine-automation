/**
 * Turbochargers Product Detail Page
 * Route: /turbochargers/[brandSlug]/[productSlug]
 * Displays detailed information about a specific turbocharger product
 *
 * Example: /turbochargers/abb/abb-turbocharger-vtr-251-2
...
export default function TurbochargerProductDetailPage() {
      ...
      <>
        ...
        <main className={styles.productDetailPage}>
          <section className={styles.errorSection}>
            ...
            {selectedBrand && (
              <Link href={`/turbochargers/${selectedBrand.slug}`}>
  ...
  return (
    <>
      <Head>
        <title>
          {product.name} - {selectedBrand.name} - Turbocharger - Skyline Marine
          Automation
        </title>
          ...
          <div className={styles.productContent}>
            ...
            <div className={styles.infoSection}>
              ...
              <div className={styles.productMeta}>
                <span className={styles.category}>Turbocharger</span>
              ...
              <div className={styles.additionalInfo}>
                ...
                <div className={styles.infoItem}>
                  ...
                  <span className={styles.value}>Turbocharger</span>
                </div>
                {product.createdAt && (
                  <div className={styles.infoItem}>
        ...
        {relatedProducts.length > 0 && (
          <section className={styles.relatedProducts}>
            <div className="container">
              <h2>More {selectedBrand.name} Turbocharger Products</h2>
              <div className={styles.productsGrid}>
                {relatedProducts.slice(0, 6).map((relProduct) => (
                  <div key={relProduct.id} className={styles.productCard}>
                    <Link
                      href={`/turbochargers/${selectedBrand.slug}/${relProduct.slug}`}
                    >
